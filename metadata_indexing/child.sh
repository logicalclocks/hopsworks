...
echo '
{
	...
	"elasticsearch.cluster" : "hopsworks",
		...
		{
		"statement" : "DELETE FROM hopsworks.meta_inodes_ops_children_p_buffer;"
		},

		{
		"statement" : "DELETE FROM hopsworks.meta_inodes_ops_parents_buffer;"
		},

		{
		"statement" : "DELETE FROM hopsworks.meta_inodes_ops_datasets_buffer;"
		}
