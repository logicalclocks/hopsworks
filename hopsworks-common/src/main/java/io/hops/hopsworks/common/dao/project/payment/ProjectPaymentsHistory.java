...
@XmlRootElement
@NamedQueries({
  @NamedQuery(name = "ProjectPaymentsHistory.findAll",
  ...
  @NamedQuery(name = "ProjectPaymentsHistory.findByAction",
          query
...
public class ProjectPaymentsHistory implements Serializable {
  ...
  public ProjectPaymentsHistory(
          ProjectPaymentsHistoryPK projectPaymentsHistoryPK) {
    this.projectPaymentsHistoryPK = projectPaymentsHistoryPK;
  }

  public ProjectPaymentsHistory(
          ProjectPaymentsHistoryPK projectPaymentsHistoryPK, String username,
          ProjectPaymentAction action, int amount) {
    this.projectPaymentsHistoryPK = projectPaymentsHistoryPK;
  ...
  public ProjectPaymentsHistory(String projectname, Date transactionDate) {
    this.projectPaymentsHistoryPK = new ProjectPaymentsHistoryPK(projectname,
            transactionDate);
  }
  ...
  public void setProjectPaymentsHistoryPK(
          ProjectPaymentsHistoryPK projectPaymentsHistoryPK) {
    this.projectPaymentsHistoryPK = projectPaymentsHistoryPK;
  }
  ...
  public int hashCode() {
    int hash = 0;
    hash += (projectPaymentsHistoryPK != null ? projectPaymentsHistoryPK.
            hashCode() : 0);
    return hash;
  }
  ...
  public boolean equals(Object object) {
    ...
    if ((this.projectPaymentsHistoryPK == null && other.projectPaymentsHistoryPK
            != null) || (this.projectPaymentsHistoryPK != null
            && !this.projectPaymentsHistoryPK.equals(
                    other.projectPaymentsHistoryPK))) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    return "se.kth.bbc.project.ProjectPaymentsHistory[ projectPaymentsHistoryPK="
            + projectPaymentsHistoryPK + " ]";
  }
