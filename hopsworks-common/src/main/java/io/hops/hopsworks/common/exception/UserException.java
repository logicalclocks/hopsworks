...
public class UserException extends RESTException {
  ...
  public UserException(RESTCodes.SecurityErrorCode code) {
    super(code);
  }
  
  public UserException(RESTCodes.SecurityErrorCode code, String usrMsg) {
    super(code, usrMsg);
  }
  
  public UserException(RESTCodes.SecurityErrorCode code, String usrMsg, String devMsg) {
