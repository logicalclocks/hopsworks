...
@Entity
@Table(name = "tf_fifo_queue",
        catalog = "hopsworks",
        schema = "")
@XmlRootElement
@NamedQueries({
  @NamedQuery(name = "TfFifoQueue.findAll",
          query = "SELECT t FROM TfFifoQueue t"),
  @NamedQuery(name = "TfFifoQueue.findById",
          query = "SELECT t FROM TfFifoQueue t WHERE t.id = :id"),
  @NamedQuery(name = "TfFifoQueue.findByNumCpus",
          query = "SELECT t FROM TfFifoQueue t WHERE t.numCpus = :numCpus"),
  @NamedQuery(name = "TfFifoQueue.findByNumGpus",
          query = "SELECT t FROM TfFifoQueue t WHERE t.numGpus = :numGpus"),
  @NamedQuery(name = "TfFifoQueue.findBySubmissionTime",
          query
          = "SELECT t FROM TfFifoQueue t WHERE t.submissionTime = :submissionTime")})
