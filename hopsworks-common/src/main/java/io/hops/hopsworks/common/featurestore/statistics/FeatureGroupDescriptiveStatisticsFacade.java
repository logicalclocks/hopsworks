...
public class FeatureGroupDescriptiveStatisticsFacade extends AbstractFacade<FeatureGroupDescriptiveStatistics> {
  
  @PersistenceContext(unitName = "kthfsPU")
  private EntityManager em;
  
  public FeatureGroupDescriptiveStatisticsFacade() {
    super(FeatureGroupDescriptiveStatistics.class);
  }
