...
public class RStudioPaths {
  ...
  public RStudioPaths(String rstudioDir, String projectName, String hdfsUser, String secretConfig) {
    projectUserPath = rstudioDir + File.separator + Settings.DIR_ROOT + File.separator + projectName + File.separator
        + hdfsUser;
