...
public interface TagSchemasControllerIface {
  void create(String name, String schema) throws FeatureStoreMetadataException;
  void delete(String name);
  void delete(TagSchemas tag);
  Map<String, String> getAll();
  
  boolean schemaHasNestedTypes(String schema) throws FeatureStoreMetadataException;
