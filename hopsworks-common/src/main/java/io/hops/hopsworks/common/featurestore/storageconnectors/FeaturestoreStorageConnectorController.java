...
public class FeaturestoreStorageConnectorController {
  ...
  public FeaturestoreJdbcConnectorDTO getOnlineFeaturestoreConnector(Users user, Featurestore featurestore)
    throws FeaturestoreException {
    return featurestoreJdbcConnectorController.getJdbcOnlineFeaturestoreConnector(user, featurestore);
  }
  ...
  private void validateUser(Users user, Featurestore featurestore) throws UserException {
    ...
    Project project = featurestore.getProject();
    for (ProjectTeam projectTeam : project.getProjectTeamCollection()) {
      if(user.getUid().equals(projectTeam.getUser().getUid())) {
