...
public class FeaturestoreConstants {
  ...
  public static final List<String> TRANSFORMATION_FUNCTION_OUTPUT_TYPES = Arrays.asList(
      // Legacy type
      "StringType()", "BinaryType()", "ByteType()", "ShortType()", "IntegerType()", "LongType()", "FloatType()",
      "DoubleType()", "TimestampType()", "DateType()", "BooleanType()",
      // Correct type
      "STRING", "BINARY", "BYTE", "SHORT", "INT", "LONG", "FLOAT", "DOUBLE", "TIMESTAMP", "DATE", "BOOLEAN");
