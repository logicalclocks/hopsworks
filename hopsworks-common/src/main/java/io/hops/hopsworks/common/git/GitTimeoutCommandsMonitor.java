...
public class GitTimeoutCommandsMonitor {
  ...
  private static final long BONUS_TIME = 1000 * 90;
  ...
  public void gitCommandMonitor(Timer timer) {
    ...
    boolean amIPrimary = payaraClusterManager.amIThePrimary();
    ...
    for (GitRepository repository : repositories) {
      ...
      if (optional.isPresent()) {
        ...
        commandExecutor.monitorCommands(execution, localMemberIp, amIPrimary, BONUS_TIME);
      } else if (amIPrimary && repository.getCid() != null) {
