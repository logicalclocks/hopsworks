...
/**
 * document attached as an xattr to a feature view directory
 */
public class FeatureViewXAttrDTO implements FeatureStoreItem {
  ...
  @JsonProperty(FeaturestoreXAttrsConstants.FV_FEATURES)
  @JsonInclude(JsonInclude.Include.NON_NULL)
  ...
  public FeatureViewXAttrDTO(Integer featurestoreId, String description,
