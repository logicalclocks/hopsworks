...
public class OauthClientFacade extends AbstractFacade<OauthClient> {
  ...
  public OauthClient findByClientId(String clientId) {
    try {
      return em.createNamedQuery("OauthClient.findByClientId", OauthClient.class).setParameter("clientId", clientId)
        .getSingleResult();
  ...
  public OauthClient findByProviderName(String providerName) {
    try {
      return em.createNamedQuery("OauthClient.findByProviderName", OauthClient.class)
