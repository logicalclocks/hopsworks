...
/**
 * Represents a JSONifiable version of the featurestore opensearch hit object
 */
@XmlRootElement
public class OpenSearchFeaturestoreHit implements Comparator<OpenSearchFeaturestoreHit> {
  
  private static final Logger LOG = Logger.getLogger(OpenSearchFeaturestoreHit.class.getName());
  ...
  public static OpenSearchFeaturestoreHit instance(SearchHit hit) throws OpenSearchException {
    OpenSearchFeaturestoreHit feHit = new OpenSearchFeaturestoreHit();
    feHit.id = hit.getId();
    ...
    try {
      ...
      String devMsg = "Hopsworks and OpenSearch types do not match - parsing problem";
  ...
  @Override
  public int compare(OpenSearchFeaturestoreHit o1, OpenSearchFeaturestoreHit o2) {
  ...
  public String toString() {
    return "FeaturestoreOpenSearchHit{" +
      "id='" + id + '\'' +
      ", score=" + score +
      ", docType='" + docType + '\'' +
      ", name='" + name + '\'' +
