...
@NamedQueries({
  ...
  @NamedQuery(name
          = "Consents.findById",
          query = "SELECT c FROM Consents c WHERE c.id = :id"),
  @NamedQuery(name
          = "Consents.findByFormType",
          query = "SELECT c FROM Consents c WHERE c.consentType = :consentType"),
  @NamedQuery(name
          = "Consents.findByStatus",
          query
          = "SELECT c FROM Consents c WHERE c.consentStatus = :consentStatus"),
  @NamedQuery(name
          = "Consents.findByProjectId",
          query = "SELECT c FROM Consents c WHERE c.project.id = :id"),
  @NamedQuery(name
          = "Consents.findByInodeId",
...
public class Consents implements Serializable {
  ...
  public Consents(ConsentType formType, ConsentStatus status, Inode inode,
          Project project) {
  ...
  public boolean equals(Object object) {
    ...
    if ((this.inode == null && other.inode != null) || (this.inode != null
            && !this.inode.equals(other.inode))) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    return "io.hops.bbc.Consents[ id=" + id + ", consentType: " + consentType
