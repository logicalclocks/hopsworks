...
/**
 * Entity class representing the featurestore_dependency table in Hopsworks database.
 * An instance of this class represents a row in the database.
 */
@Entity
@Table(name = "featurestore_dependency", catalog = "hopsworks")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "FeaturestoreDependency.findAll", query = "SELECT fd FROM FeaturestoreDependency fd"),
    @NamedQuery(name = "FeaturestoreDependency.findById",
        query = "SELECT fd FROM FeaturestoreDependency fd WHERE fd.id = :id")})
public class FeaturestoreDependency implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof FeaturestoreDependency)) return false;

    FeaturestoreDependency that = (FeaturestoreDependency) o;
    ...
    if (trainingDataset != null ? !trainingDataset.equals(that.trainingDataset) : that.trainingDataset != null)
      return false;
    return inode.equals(that.inode);
  }
