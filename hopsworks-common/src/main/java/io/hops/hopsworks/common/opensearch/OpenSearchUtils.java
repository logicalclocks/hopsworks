...
public class OpenSearchUtils {
  ...
  public static String getValidRole(String role) throws OpenSearchException {
    if(role == null){
      throw new OpenSearchException(RESTCodes.OpenSearchErrorCode.INVALID_OPENSEARCH_ROLE_USER,
    ...
    throw new OpenSearchException(RESTCodes.OpenSearchErrorCode.INVALID_OPENSEARCH_ROLE,
