...
public class TestFeatureStoreInputValidation {
  ...
  public void testVerifyUserInputFeatureGroup() throws Exception {
    FeaturegroupDTO featuregroupDTO = new FeaturegroupDTO(1, "featurestore", 1, "1wrong_name", 1, false);
    // upper case
  ...
  public void testVerifyDescription() throws Exception {
    FeaturegroupDTO featuregroupDTO = new FeaturegroupDTO(1, "featurestore", 1, "wrong_name", 1, false);
