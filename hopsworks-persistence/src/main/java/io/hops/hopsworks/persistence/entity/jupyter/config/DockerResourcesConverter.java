...
public class DockerResourcesConverter implements AttributeConverter<DockerResourcesConfiguration, String> {
  ...
  static {
    try {
      dockerJAXBContext = JAXBContextFactory.createContext(new Class[] {DockerResourcesConfiguration.class}, null);
  ...
  private DockerResourcesConfiguration unmarshal(String jsonConfig, JAXBContext jaxbContext) throws JAXBException {
    ...
    return unmarshaller.unmarshal(json, DockerResourcesConfiguration.class).getValue();
  }
}
