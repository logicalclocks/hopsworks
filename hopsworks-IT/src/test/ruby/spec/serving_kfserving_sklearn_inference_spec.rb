...
# serving_kfserving_sklearn_inference_spec.rb: Tests for making inference with sklearn models on KFServing
...
describe "On #{ENV['OS']}" do
  ...
  after (:all) do
    clean_all_test_projects(spec: "serving_kfserving_sklearn_inference")
