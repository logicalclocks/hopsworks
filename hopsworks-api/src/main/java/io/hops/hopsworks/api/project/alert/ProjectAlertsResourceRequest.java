...
public class ProjectAlertsResourceRequest extends ResourceRequest {

  public ProjectAlertsResourceRequest(Name name, String queryParam) {
    super(name, queryParam);
    //Set sort_by
    Set<ProjectAlertsFilterBy> filters = null;
    for (String queryProp : queryProps) {
      if (queryProp.startsWith("sort_by")) {
        ...
        Set<ProjectAlertsSortBy> sortBys = new LinkedHashSet<>();//make ordered
        ...
        //Set filter_by
        ProjectAlertsFilterBy filterBy = new ProjectAlertsFilterBy(queryProp.substring(queryProp.indexOf('=') + 1));
