...
public class OpenSearchFeaturestoreRequest {
  private String term;
  private FeaturestoreDocType docType;
  private Integer from;
  private Integer size;
  
  public OpenSearchFeaturestoreRequest() {
  }
  
  public OpenSearchFeaturestoreRequest(String term, FeaturestoreDocType docType, Integer from, Integer size) {
    this.term = term;
