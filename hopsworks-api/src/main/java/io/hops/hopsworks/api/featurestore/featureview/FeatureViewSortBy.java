...
public class FeatureViewSortBy implements AbstractFacade.SortBy {

  private final FeatureViewFacade.Sorts sortBy;
  private final AbstractFacade.OrderBy param;

  public FeatureViewSortBy(String param) {
    String[] sortByParams = param.split(":");
    String sort = "";
    try {
      sort = sortByParams[0].toUpperCase();
      this.sortBy = FeatureViewFacade.Sorts.valueOf(sort);
