 ...
 * same ticket
 * The Map size is at most the number of different user names having access to a
 * Zeppelin instance
 */
public class TicketContainer {
  ...
  /**
   * get or create ticket for Websocket authentication assigned to authenticated
   * shiro user
