...
public class FeatureGroupAlertSortBy implements AbstractFacade.SortBy {

  private final FeatureGroupAlertFacade.Sorts sortBy;
  private final AbstractFacade.OrderBy param;

  public FeatureGroupAlertSortBy(String param) {
    String[] sortByParams = param.split(":");
    String sort = "";
    try {
      sort = sortByParams[0].toUpperCase();
      this.sortBy = FeatureGroupAlertFacade.Sorts.valueOf(sort);
