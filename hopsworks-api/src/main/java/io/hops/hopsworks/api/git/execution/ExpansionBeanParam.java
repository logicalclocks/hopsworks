...
public class ExpansionBeanParam {
  @QueryParam("expand")
  @ApiParam(value = "ex. expand=user", allowableValues = "expand=user, expand=repository")
  ...
  public Set<ResourceRequest> getResources(){
    ...
    for(ExecutionExpansions executionExpansion : this.expansions){
      expansions.add(executionExpansion.getResourceRequest());
    }
    return expansions;
  }
}
