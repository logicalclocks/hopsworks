...
public class ModelRegistryExpansions implements Expansions {
  private ResourceRequest resourceRequest;

  public ModelRegistryExpansions(String queryParam) {
    ...
    switch (name) {
      case MODELS:
        resourceRequest = new ModelsResourceRequest(name, queryParam);
        break;
      default:
        break;
    }
