...
public class ThirdPartyApiKeysBuilder {
  
  public ThirdPartyApiKeyDTO build(List<ThirdPartyApiKeyPlaintext> apiKeys) {
    ThirdPartyApiKeyDTO dto = new ThirdPartyApiKeyDTO();
    apiKeys.stream()
        .map(this::buildDTO)
