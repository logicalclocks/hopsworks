...
public class SortBy implements AbstractFacade.SortBy {
  private final EnvironmentHistoryFacade.Sorts sortBy;
  ...
  public SortBy(String param) {
    ...
    try {
      ...
      this.sortBy = EnvironmentHistoryFacade.Sorts.valueOf(sort);
  ...
  @Override
  public String getValue() { return this.sortBy.getValue(); }

  @Override
  public AbstractFacade.OrderBy getParam() { return this.param; }

  @Override
  public String getSql() { return this.sortBy.getSql(); }
}
