...
public class ProjectService {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  public Response getMoreInfo(@PathParam("type") String type, @PathParam("id") Integer id) throws AppException {
  ...
  public Response getPublicDatasets(
    ...
    GenericEntity<List<DataSetDTO>> datasets = new GenericEntity<List<DataSetDTO>>(publicDatasets) {
    };
