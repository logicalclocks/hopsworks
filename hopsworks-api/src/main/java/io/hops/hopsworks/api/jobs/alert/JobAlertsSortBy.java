...
public class JobAlertsSortBy implements AbstractFacade.SortBy {

  private final JobAlertsFacade.Sorts sortBy;
  private final AbstractFacade.OrderBy param;

  public JobAlertsSortBy(String param) {
    String[] sortByParams = param.split(":");
    String sort = "";
    try {
      sort = sortByParams[0].toUpperCase();
      this.sortBy = JobAlertsFacade.Sorts.valueOf(sort);
