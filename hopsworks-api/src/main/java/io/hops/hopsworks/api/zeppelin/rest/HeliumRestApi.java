...
public class HeliumRestApi {
  ...
  public void setParms(ZeppelinConfig zeppelinConf) {
    this.helium = zeppelinConf.getHelium();
  ...
  public Response getAll() {
    return new JsonResponse(Response.Status.OK, "", helium.getAllPackageInfo()).
            build();
  }
  ...
  public Response suggest(@PathParam("noteId") String noteId,
    ...
    if (paragraph == null) {
      return new JsonResponse(Response.Status.NOT_FOUND, "Paragraph "
              + paragraphId + " not found").build();
    }

    return new JsonResponse(Response.Status.OK, "", helium.suggestApp(paragraph)).
            build();
  }
  ...
  public Response enablePackage(@PathParam("packageName") String packageName,
    ...
    try {
      ...
      logger.error(e.getMessage(), e);
      return new JsonResponse(Response.Status.INTERNAL_SERVER_ERROR, e.
              getMessage()).build();
    }
  }
