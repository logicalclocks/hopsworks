...
public class AuditedInterceptor implements Serializable {
  ...
  public Object collectBasicAuditInformation(InvocationContext context) throws Exception {
    ...
    try {
      ...
      auditHelper.saveAudit(audited, method, parameters, AuditActionStatus.FAILED, req);
      throw e;
    }
    auditHelper.saveAudit(audited, method, parameters, AuditActionStatus.SUCCESS, req);
    return ret;
  }
}
