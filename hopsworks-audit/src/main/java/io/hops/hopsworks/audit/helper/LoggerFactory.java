...
public class LoggerFactory {
  ...
  private void init() {
    ...
    int logFileSize = getIntValue(AUDIT_LOG_FILE_SIZE, 103809000);
    int logFileCount = getIntValue(AUDIT_LOG_FILE_COUNT, 10);
    ...
    try {
      fileHandler = new FileHandler(logDir + "/server.log", logFileSize, logFileCount, true);
