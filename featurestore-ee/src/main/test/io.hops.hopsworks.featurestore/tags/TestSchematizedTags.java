...
public class TestSchematizedTags {
  ...
  @Test
  public void testMalformedJSONTag() throws FeatureStoreTagException {
    String schemaS = "{";
    schemaS +=  "$schema : \"http://json-schema.org/draft-07/schema#\",";
    schemaS += "$id : \"http://example.com/product.schema.json\",";
    schemaS += "title : \"Test Schema\",";
  ...
  @Test
  public void testMalformedTag() throws FeatureStoreTagException {
  ...
  @Test
  public void testPropertyTypeStringArray() throws FeatureStoreTagException {
    Random rand = new Random(123);
  ...
  @Test
  public void testPropertyTypeIntArray() throws FeatureStoreTagException {
    Random rand = new Random(123);
  ...
  @Test
  public void testPropertyTypeBadIntArray1() throws FeatureStoreTagException {
    Random rand = new Random(123);
    String schemaS = arrayFieldSchema1("integer");
    Schema schema = SchematizedTagHelper.validateSchema(schemaS);
    String val = "{";
  ...
  @Test
  public void testPropertyTypeBadIntArray2() throws FeatureStoreTagException {
    Random rand = new Random(123);
    String schemaS = arrayFieldSchema1("integer");
    Schema schema = SchematizedTagHelper.validateSchema(schemaS);
    String val = "{";
  ...
  @Test
  public void testPropertyTypeFloatArray() throws FeatureStoreTagException {
    Random rand = new Random(123);
  ...
  @Test
  public void testPropertyTypeBadFloatArray() throws FeatureStoreTagException {
    Random rand = new Random(123);
    String schemaS = arrayFieldSchema1("number");
    Schema schema = SchematizedTagHelper.validateSchema(schemaS);
    String val = "{";
  ...
  @Test
  public void testPropertyTypeBoolArray() throws FeatureStoreTagException {
  ...
  @Test
  public void testSchemaTypePrimitiveString() throws FeatureStoreTagException {
    String schemaS = "{";
    schemaS +=  "$schema : \"http://json-schema.org/draft-07/schema#\",";
    schemaS += "$id : \"http://example.com/product.schema.json\",";
    schemaS += "\"type\" : \"string\"";
  ...
  @Test
  public void testSchemaTypePrimitiveInteger() throws FeatureStoreTagException {
    String schemaS = "{";
    schemaS +=  "$schema : \"http://json-schema.org/draft-07/schema#\",";
    schemaS += "$id : \"http://example.com/product.schema.json\",";
    schemaS += "\"type\" : \"integer\"";
  ...
  @Test
  public void testSchemaTypePrimitiveIntegerBad() throws FeatureStoreTagException {
    String schemaS = "{";
    schemaS +=  "$schema : \"http://json-schema.org/draft-07/schema#\",";
    schemaS += "$id : \"http://example.com/product.schema.json\",";
    schemaS += "\"type\" : \"integer\"";
  ...
  @Test
  public void testSchemaTypePrimitiveFloat() throws  FeatureStoreTagException {
    String schemaS = "{";
    schemaS +=  "$schema : \"http://json-schema.org/draft-07/schema#\",";
    schemaS += "$id : \"http://example.com/product.schema.json\",";
    schemaS += "\"type\" : \"number\"";
  ...
  @Test
  public void testSchemaTypePrimitiveBoolean() throws FeatureStoreTagException {
    String schemaS = "{";
    schemaS += "$schema : \"http://json-schema.org/draft-07/schema#\",";
    schemaS += "$id : \"http://example.com/product.schema.json\",";
  ...
  @Test
  public void testSchemaTypePrimitiveStringArray() throws FeatureStoreTagException {
    String schemaS = "{";
    schemaS += "$schema : \"http://json-schema.org/draft-07/schema#\",";
    schemaS += "$id : \"http://example.com/product.schema.json\",";
    schemaS += "\"type\" : \"array\",";
  ...
  @Test
  public void testComplexSuccess() throws FeatureStoreTagException {
  ...
  @Test
  public void testComplexFail1() throws FeatureStoreTagException {
    String schemaS ="{\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"$id\":\"http://heap.com/test.schema.json\",\"allOf\":[{\"$ref\":\"#/definitions/disease\"},{\"$ref\":\"#/definitions/cancer\"},{\"$ref\":\"#/definitions/other\"}],\"definitions\":{\"disease\":{\"properties\":{\"disease_type\":{\"type\":\"string\"}}},\"cancer\":{\"properties\":{\"cancer_type\":{\"type\":\"string\"}}},\"other\":{\"properties\":{\"other_field\":{\"type\":\"string\"}}}},\"required\":[\"disease\"],\"if\":{\"properties\":{\"disease\":{\"const\":\"Cancer\"}}},\"then\":{\"required\":[\"cancer_type\"]}}";
    SchematizedTagHelper.validateSchema(schemaS);
    String val = "{\"disease\":\"Cancer\"}";
    thrown.expect(FeatureStoreTagException.class);
    thrown.expectMessage("#: #: only 2 subschema matches out of 3");
    SchematizedTagHelper.validateTag(schemaS, val);
  }
  
  @Test
  public void testComplexSuccess2() throws FeatureStoreTagException {
    String schemaS ="{\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"$id\":\"http://heap.com/test.schema.json\",\"allOf\":[{\"$ref\":\"#/definitions/disease\"},{\"$ref\":\"#/definitions/cancer\"},{\"$ref\":\"#/definitions/other\"}],\"definitions\":{\"disease\":{\"properties\":{\"disease_type\":{\"type\":\"string\"}}},\"cancer\":{\"properties\":{\"cancer_type\":{\"type\":\"string\"}}},\"other\":{\"properties\":{\"other_field\":{\"type\":\"string\"}}}},\"required\":[\"disease\"],\"if\":{\"properties\":{\"disease\":{\"const\":\"Cancer\"}}},\"then\":{\"required\":[\"cancer_type\"]}}";
    SchematizedTagHelper.validateSchema(schemaS);
  ...
  @Test
  public void testC() throws FeatureStoreTagException {
