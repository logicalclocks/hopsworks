...
def create_project(endpoint, user, password, owner, project_name):
    "Login to Hopsworks as admin <admin@hopsworks.com> user and create a Project with owner as Project Owner"
...
if __name__=='__main__':
    ...
    parser.add_argument('-e', '--endpoint', required=True,
                        help='Hopsworks host')
    parser.add_argument('-u', '--user', default='admin@hopsworks.com',
                        help='Admin user')
