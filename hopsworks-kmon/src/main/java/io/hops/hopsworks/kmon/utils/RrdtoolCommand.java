...
public class RrdtoolCommand {
  ...
  private static final Logger logger = Logger.getLogger(RrdtoolCommand.class.
          getName());
  ...
  public RrdtoolCommand(String filePath, String fileExtension, String hostId,
  ...
  public void drawSumLine(List<String> hosts, String type, String typeInstance,
          String ds, String label, String color, String detailsFormat) {
    List<String> vars = new ArrayList<String>();
    String cmd;
    for (String h : hosts) {
      String var = h.replace(".", "-") + "-" + type + "-" + typeInstance + ds;
      String rrdFile = getRrdFileName(h, plugin, pluginInstance, type,
              typeInstance);
  ...
  public void drawAverageLine(List<String> hosts, String type,
          String typeInstance, String ds, String label, String color,
  ...
  public void drawLine(String type, String typeInstance, String ds, String label,
          String color, String detailsFormat) {
    addGraph(ChartType.LINE, type, typeInstance, ds, label, color, detailsFormat);
  }

  public void drawArea(String type, String typeInstance, String ds, String label,
          String color, String detailsFormat) {
    addGraph(ChartType.AREA, type, typeInstance, ds, label, color, detailsFormat);
  }

  public void stackArea(String type, String typeInstance, String ds,
          String label, String color, String detailsFormat) {
    addGraph(ChartType.AREA_STACK, type, typeInstance, ds, label, color,
            detailsFormat);
  }

  private void addGraph(ChartType chartType, String type, String typeInstance,
          String ds, String label, String color,
          String detailsFormat) {
    String var = type + "-" + typeInstance + ds;
    String rrdFile = getRrdFileName(hostId, plugin, pluginInstance, type,
            typeInstance);
  ...
  private String getRrdFileName(String hostId, String plugin,
