...
public class CAConfiguration {
  ...
  final private String x509Name;

  @SerializedName("validityDuration")
  final private String validityDuration;

  public CAConfiguration(String x509Name, String validityDuration) {
    this.x509Name = x509Name;
    this.validityDuration = validityDuration;
  }

  public Optional<String> getX509Name() {
    return Optional.ofNullable(x509Name);
  }

  public Optional<String> getValidityDuration() {
    return Optional.ofNullable(validityDuration);
  }
}
