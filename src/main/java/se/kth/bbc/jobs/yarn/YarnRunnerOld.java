 ...
 * @author stig
 */
public class YarnRunnerOld implements CancellableJob {

  public static final String APPID_PLACEHOLDER = "$APPID";
  private static final String APPID_REGEX = "\\$APPID";

  private static final Logger logger = Logger.getLogger(YarnRunnerOld.class.
          getName());
  ...
  private YarnRunnerOld(Builder builder) {
  ...
  public static class Builder {
     ...
     * @return
     */
    public YarnRunnerOld build() throws IllegalStateException {
      //Set configuration
      try {
        setConfiguration();
