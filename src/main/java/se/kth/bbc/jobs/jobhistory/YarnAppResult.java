...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "YarnAppResult.findAll", query = "SELECT y FROM YarnAppResult y"),
    @NamedQuery(name = "YarnAppResult.findById", query = "SELECT y FROM YarnAppResult y WHERE y.id = :id"),
    @NamedQuery(name = "YarnAppResult.findByUsername", query = "SELECT y FROM YarnAppResult y WHERE y.username = :username"),
    @NamedQuery(name = "YarnAppResult.findByStartTime", query = "SELECT y FROM YarnAppResult y WHERE y.startTime = :startTime"),
    @NamedQuery(name = "YarnAppResult.findByFinishTime", query = "SELECT y FROM YarnAppResult y WHERE y.finishTime = :finishTime"),
    @NamedQuery(name = "YarnAppResult.findByJobType", query = "SELECT y FROM YarnAppResult y WHERE y.jobType = :jobType"),
    @NamedQuery(name = "YarnAppResult.findBySeverity", query = "SELECT y FROM YarnAppResult y WHERE y.severity = :severity"),
    @NamedQuery(name = "YarnAppResult.findByScore", query = "SELECT y FROM YarnAppResult y WHERE y.score = :score"),
    @NamedQuery(name = "YarnAppResult.findByWorkflowDepth", query = "SELECT y FROM YarnAppResult y WHERE y.workflowDepth = :workflowDepth"),
    @NamedQuery(name = "YarnAppResult.findByFlowExecId", query = "SELECT y FROM YarnAppResult y WHERE y.flowExecId = :flowExecId"),
    @NamedQuery(name = "YarnAppResult.findByJobDefId", query = "SELECT y FROM YarnAppResult y WHERE y.jobDefId = :jobDefId"),
    @NamedQuery(name = "YarnAppResult.findByFlowDefId", query = "SELECT y FROM YarnAppResult y WHERE y.flowDefId = :flowDefId")})
public class YarnAppResult implements Serializable {
    ...
    public YarnAppResult(String id, String username, long startTime, long finishTime, String jobType, short severity, String flowExecId, String jobDefId, String flowDefId) {
        this.id = id;
