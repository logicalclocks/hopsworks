...
public class JobHistoryFacade extends AbstractFacade<JobHistory> {
  ...
  public JobHistory update(JobHistory history, JobState newState) {
    ...
    return update(history, null, newState, -1, null, null, null, null,
            null);
  }

  public JobHistory update(JobHistory history, JobState newState,
          long executionTime) {
    return update(history, null, newState, executionTime, null, null, null,
            null, null);
  }
  ...
  public JobHistory update(JobHistory history,
    ...
    return update(history, null, null, -1, null, null, null, null,
            extraOutputFiles);
  }
  ...
  public JobHistory create(String jobname, String userEmail, Project project,
          JobType type, JobState state, String stdOutPath, String stdErrPath,
  ...
  public JobHistory updateStdOutPath(JobHistory history, String stdOutPath) {
    return update(history, null, null, -1, stdOutPath, null, null, null,
            null);
  }

  public JobHistory updateStdErrPath(JobHistory history, String stdErrPath) {
    return update(history, null, null, -1, null, stdErrPath, null, null,
            null);
  }

  public JobHistory updateAppId(JobHistory history, String appId) {
    return update(history, null, null, -1, null, null,
            appId, null, null);
  }
