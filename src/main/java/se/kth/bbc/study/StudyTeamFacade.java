...
public class StudyTeamFacade {
  ...
  public List<Username> findTeamMembersByName(String name, String role) {
    Query query = em.createNativeQuery(
            "SELECT NAME, EMAIL FROM USERS WHERE EMAIL IN (SELECT team_member FROM StudyTeam WHERE name=? AND team_role=?)",
            Username.class)
  ...
  public List<TrackStudy> findStudyMaster(String name) {
    Query query = em.createNativeQuery(
            "SELECT * FROM study WHERE name IN (SELECT name FROM StudyTeam WHERE name=?)",
  ...
  public List<StudyTeam> findCurrentRole(String name, String username) {
    ...
    Query query = em.createNativeQuery(
            "SELECT * FROM StudyTeam where name=? AND team_member=?",
