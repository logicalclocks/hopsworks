...
public class StudyTeamPK implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.teamMember == null && other.teamMember != null) || (this.teamMember != null && !this.teamMember.equals(other.teamMember))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "se.kth.bbc.study.StudyTeamPK[ name=" + name + ", teamMember=" + teamMember + " ]";
    }
