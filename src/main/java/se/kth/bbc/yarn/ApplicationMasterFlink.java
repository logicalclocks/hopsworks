...
/**
 *
 * @author https://github.com/apache/incubator-flink/blob/master/flink-addons/flink-yarn/src/main/java/org/apache/flink/yarn/appMaster/ApplicationMaster.java
 */
public class ApplicationMasterFlink{
/*
	...
	public ApplicationMasterFlink(Configuration conf) throws IOException {
	...
	private void startJobManager() throws Exception {
		Utils.copyJarContents("resources/"+ConfigConstants.DEFAULT_JOB_MANAGER_WEB_PATH_NAME,
				ApplicationMasterFlink.class.getProtectionDomain().getCodeSource().getLocation().getPath());
	...
	public static void main(String[] args) throws Exception {
		...
		ugi.doAs(new PrivilegedAction<Object>() {
			...
			public Object run() {
				...
				ApplicationMasterFlink am = null;
				try {
					...
					am = new ApplicationMasterFlink(conf);
