...
public class UserAccountsEmailMessages {
    ...
    public static String buildYubikeyRequestMessage(String path, String key) {
        ...
        String l4 = "If you have any questions please contact " + BIOBANKCLOUD_SUPPORT_EMAIL;
    ...
    public static String buildMobileRequestMessage(String path, String key) {
        ...
        String l2 = "Your account will be activated within " + ACCOUNT_ACITVATION_PERIOD + " hours after validating your email address.\n\n\n";
