...
@NamedQueries({
    ...
    @NamedQuery(name = "Organization.findByContactEmail", query = "SELECT o FROM Organization o WHERE o.contactEmail = :contactEmail"),
    @NamedQuery(name = "Organization.findByDepartment", query = "SELECT o FROM Organization o WHERE o.department = :department"),
    @NamedQuery(name = "Organization.findByPhone", query = "SELECT o FROM Organization o WHERE o.phone = :phone"),
    @NamedQuery(name = "Organization.findByFax", query = "SELECT o FROM Organization o WHERE o.fax = :fax")})
