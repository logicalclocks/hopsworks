...
@NamedQueries({
  @NamedQuery(name = "Yubikey.findAll",
          query
          = "SELECT y FROM Yubikey y"),
  @NamedQuery(name = "Yubikey.findBySerial",
          query
          = "SELECT y FROM Yubikey y WHERE y.serial = :serial"),
  @NamedQuery(name = "Yubikey.findByVersion",
          query
          = "SELECT y FROM Yubikey y WHERE y.version = :version"),
  @NamedQuery(name = "Yubikey.findByNotes",
          query
          = "SELECT y FROM Yubikey y WHERE y.notes = :notes"),
  @NamedQuery(name = "Yubikey.findByCounter",
          query
          = "SELECT y FROM Yubikey y WHERE y.counter = :counter"),
  @NamedQuery(name = "Yubikey.findByLow",
          query
          = "SELECT y FROM Yubikey y WHERE y.low = :low"),
  @NamedQuery(name = "Yubikey.findByHigh",
          query
          = "SELECT y FROM Yubikey y WHERE y.high = :high"),
  @NamedQuery(name = "Yubikey.findBySessionUse",
          query
          = "SELECT y FROM Yubikey y WHERE y.sessionUse = :sessionUse"),
  @NamedQuery(name = "Yubikey.findByCreated",
          query
          = "SELECT y FROM Yubikey y WHERE y.created = :created"),
  @NamedQuery(name = "Yubikey.findByAesSecret",
          query
          = "SELECT y FROM Yubikey y WHERE y.aesSecret = :aesSecret"),
  @NamedQuery(name = "Yubikey.findByPublicId",
          query
          = "SELECT y FROM Yubikey y WHERE y.publicId = :publicId"),
  @NamedQuery(name = "Yubikey.findByAccessed",
          query
          = "SELECT y FROM Yubikey y WHERE y.accessed = :accessed"),
  @NamedQuery(name = "Yubikey.findByStatus",
          query
          = "SELECT y FROM Yubikey y WHERE y.status = :status"),
  @NamedQuery(name = "Yubikey.findByYubidnum",
          query
          = "SELECT y FROM Yubikey y WHERE y.yubidnum = :yubidnum"),
  @NamedQuery(name = "Yubikey.findByUid",
          query
          = "SELECT y FROM Yubikey y WHERE y.uid = :uid")})
public class Yubikey implements Serializable {
  ...
  public Yubikey(Integer yubidnum, Date created, int uid) {
    this.yubidnum = yubidnum;
