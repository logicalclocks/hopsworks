...
public class AdminProfileAministration implements Serializable {
  ...
  public String getEditStatus() {
    ...
    int stat = userManager.getUserByEmail(this.editingUser.getEmail()).
            getStatus();
    this.editStatus = PeopleAccountStatus.values()[stat - 1].name();
  ...
  public void updateStatusByAdmin() throws SocketException {
    ...
    String mac = AuditUtil.getMacAddress(ip);
    ...
    if (!"#".equals(selectedStatus)) {
      ...
      // Register the logging info
      am.
              registerRoleChange(init, AccountsAuditActions.USERMANAGEMENT.
                      getValue(), ip, brower, os,
                      mac, "SUCCESS", selectedStatus, editingUser);
      ...
      am.
              registerRoleChange(init, AccountsAuditActions.USERMANAGEMENT.
                      getValue(), ip, brower, os,
                      mac, "FAIL", selectedStatus, editingUser);
  ...
  public void addRoleByAdmin() throws SocketException {
    ...
    if (!"#".equals(newGroup)) {
      ...
      // Register the logging info
      am.registerRoleChange(init, RolesAuditActions.ADDROME.getValue(), ip,
              brower, os,
              mac, "SUCCESS", newGroup, editingUser);
  ...
  public void removeRoleByAdmin() throws SocketException {
    ...
    if (!"#".equals(selectedGroup)) {
      if (selectedGroup.equals(BBCGroup.BBC_GUEST.toString())) {
        ...
        // Register the logging info
        am.registerRoleChange(init, RolesAuditActions.REMOVEROLE.getValue(), ip,
                brower, os,
                mac, "SUCCESS", selectedGroup, editingUser);
      } else {
    ...
    if ("#".equals(selectedGroup)) {
      ...
      if (("#".equals(selectedStatus))
        ...
        am.registerRoleChange(init, RolesAuditActions.REMOVEROLE.getValue(), ip,
                brower, os,
                mac, "FAIL", selectedGroup, editingUser);
      }
    }
