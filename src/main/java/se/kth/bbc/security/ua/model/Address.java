...
@NamedQueries({
  ...
  @NamedQuery(name = "Address.findByAddress1",
          query
          = "SELECT a FROM Address a WHERE a.address1 = :address1"),
  ...
  @NamedQuery(name = "Address.findByAddress3",
          query
          = "SELECT a FROM Address a WHERE a.address3 = :address3"),
  ...
  @NamedQuery(name = "Address.findByCountry",
          query
          = "SELECT a FROM Address a WHERE a.country = :country"),
  ...
  @NamedQuery(name = "Address.findByUid",
          query
          = "SELECT a FROM Address a WHERE a.uid = :uid")})
