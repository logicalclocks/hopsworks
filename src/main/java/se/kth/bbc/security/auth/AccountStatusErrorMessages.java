...
public class AccountStatusErrorMessages {
    ...
    public final static String USER_NOT_FOUND ="No account found for this email address.";
    ...
    public final static String DEACTIVATED_ACCOUNT ="This account is not in use anymore.";
    
    public final static String INCORRECT_PIN ="PIN must be 6 charachters.";
    
    public final static String PIN_REQUIERMENTS ="PPIN must be numeric.";
