...
public class AccountStatusErrorMessages {
  ...
  public final static String PASSWORD_REQUIREMNTS
          = "Password must contain at least 6 characters.";

  public final static String TOS_ERROR = "ToS not agreed";

  public final static String PASSWORD_ALPAHNUMERIC
          = "Passowrs is not alphanumeric.";
  ...
  public final static String INCCORCT_DEACTIVATION_LENGTH
          = "The message should not be less than 5 chars and more than 500 chars.";
