...
public class QRCodeGenerator {
    ...
    private BitMatrix generateMatrix() throws WriterException {
        return qrw.encode(qrURL, com.google.zxing.BarcodeFormat.QR_CODE, width, height);
    }
     ...
     */
    public static StreamedContent getQRCode(String user,  String host, String secret) throws UnsupportedEncodingException, IOException, WriterException {
