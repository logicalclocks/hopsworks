...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "InodeOps.findAll", query = "SELECT i FROM InodeOps i"),
    @NamedQuery(name = "InodeOps.findByInodeid", query = "SELECT i FROM InodeOps i WHERE i.inodeid = :inodeid"),
    @NamedQuery(name = "InodeOps.findByInodePid", query = "SELECT i FROM InodeOps i WHERE i.inodePid = :inodePid"),
    @NamedQuery(name = "InodeOps.findByInodeRoot", query = "SELECT i FROM InodeOps i WHERE i.inodeRoot = :inodeRoot"),
    @NamedQuery(name = "InodeOps.findByModified", query = "SELECT i FROM InodeOps i WHERE i.modified = :modified")})
