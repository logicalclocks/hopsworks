...
public class ActivityController {
    ...
    /**
     * Returns all activities on study <i>studyName</i>, but paginated. Items
     * from
     * <i>first</i> till
     * <i>first+pageSize</i> are returned.
     * <p>
    ...
    /**
     * Returns all activities on user <i>performedByEmail</i>, but paginated.
     * Items from
     * <i>first</i> till
     * <i>first+pageSize</i> are returned.
     * <p>
     * @param first
     * @param pageSize
     * @param performedByEmail
     * @return
     */
    public List<ActivityDetail> getPaginatedActivityDetailForUser(int first,
            int pageSize, String performedByEmail) {
        TypedQuery<ActivityDetail> q = em.createNamedQuery(
                "ActivityDetail.findByPerformedByEmail", ActivityDetail.class);
        q.setParameter("performedByEmail", performedByEmail);
        q.setFirstResult(first);
        q.setMaxResults(pageSize);
        return q.getResultList();
    }
    ...
    /**
     * Get all the activities performed by a user <i>performedByEmail</i>.
     * <p>
     * @param performedByEmail
     * @return
     */
    public List<ActivityDetail> activityDetailOnUser(String performedByEmail) {
        TypedQuery<ActivityDetail> q = em.createNamedQuery(
                "ActivityDetail.findByPerformedByEmail", ActivityDetail.class);
        q.setParameter("performedByEmail", performedByEmail);
        return q.getResultList();
    ...
    public long countActivityByEmail(String performedByEmail) {
        TypedQuery<Long> q = em.
                createNamedQuery("ActivityDetail.countByPerformedByEmail", Long.class);
        q.setParameter("performedByEmail", performedByEmail);
