...
public class Constants {
  ...
  public static final String ADAM_DEFAULT_JAR_HDFS_PATH
          = "hdfs:///user/adam/adam-cli-0.15.1-SNAPSHOT.jar";
  ...
  public static final String[] ADAM_HDFS_JARS = {
    "/user/adam/args4j-2.0.23.jar",
    "/user/adam/snappy-java-1.1.1.6.jar",
    "/user/adam/commons-jexl-2.1.1.jar",
    "/user/adam/commons-compress-1.4.1.jar",
    "/user/adam/bcel-5.2.jar",
    "/user/adam/ant-1.8.2.jar",
    "/user/adam/ant-launcher-1.8.2.jar",
    "/user/adam/avro-1.7.6.jar",
    "/user/adam/httpclient-4.3.2.jar",
    "/user/adam/httpcore-4.3.1.jar",
    "/user/adam/joda-convert-1.6.jar",
    "/user/adam/xz-1.0.jar",
    "/user/adam/bsh-2.0b4.jar",
    "/user/adam/jackson-core-asl-1.9.13.jar",
    "/user/adam/jackson-mapper-asl-1.9.13.jar",
    "/user/adam/scalatra-common_2.10-2.3.0.jar",
    "/user/adam/rl_2.10-0.4.10.jar",
    "/user/adam/scalatra-json_2.10-2.3.0.jar",
    "/user/adam/scalatra_2.10-2.3.0.jar",
    "/user/adam/bdg-formats-0.4.0.jar",
    "/user/adam/bdg-utils-parquet-0.1.1.jar",
    "/user/adam/bdg-utils-misc-0.1.1.jar",
    "/user/adam/bdg-utils-metrics-0.1.1.jar",
    "/user/adam/adam-apis-0.16.0.jar",
    "/user/adam/adam-core-0.16.0.jar",
    "/user/adam/adam-cli-0.16.0.jar",
    "/user/adam/testng-6.8.8.jar",
    "/user/adam/json4s-ast_2.10-3.2.10.jar",
    "/user/adam/json4s-core_2.10-3.2.10.jar",
    "/user/adam/slf4j-api-1.7.5.jar",
    "/user/adam/slf4j-log4j12-1.7.5.jar",
    "/user/adam/asm-4.0.jar",
    "/user/adam/scalap-2.10.0.jar",
    "/user/adam/scala-library-2.10.4.jar",
    "/user/adam/scala-reflect-2.10.4.jar",
    "/user/adam/scala-compiler-2.10.0.jar",
    "/user/adam/objenesis-1.2.jar",
    "/user/adam/scalate-util_2.10-1.6.1.jar",
    "/user/adam/scalate-core_2.10-1.6.1.jar",
    "/user/adam/grizzled-slf4j_2.10-1.0.2.jar",
    "/user/adam/cofoja-1.1-r150.jar",
    "/user/adam/htsjdk-1.118.jar",
    "/user/adam/hadoop-bam-7.0.0.jar",
    "/user/adam/scalac-scoverage-plugin_2.10-0.99.2.jar",
    "/user/adam/commons-logging-1.1.1.jar",
    "/user/adam/log4j-1.2.17.jar",
    "/user/adam/commons-cli-1.2.jar",
    "/user/adam/joda-time-2.3.jar",
    "/user/adam/commons-codec-1.4.jar",
    "/user/adam/commons-io-1.3.2.jar",
    "/user/adam/mime-util-2.1.3.jar",
    "/user/adam/jakarta-regexp-1.4.jar",
    "/user/adam/minlog-1.2.jar",
    "/user/adam/reflectasm-1.07-shaded.jar",
    "/user/adam/kryo-2.21.jar",
    "/user/adam/servo-core-0.5.5.jar",
    "/user/adam/paranamer-2.3.jar",
    "/user/adam/guava-14.0.1.jar",
    "/user/adam/annotations-2.0.0.jar",
    "/user/adam/parquet-column-1.6.0rc4.jar",
    "/user/adam/parquet-generator-1.6.0rc4.jar",
    "/user/adam/parquet-hadoop-1.6.0rc4.jar",
    "/user/adam/parquet-jackson-1.6.0rc4.jar",
    "/user/adam/parquet-common-1.6.0rc4.jar",
    "/user/adam/parquet-format-2.2.0-rc1.jar",
    "/user/adam/parquet-avro-1.6.0rc4.jar",
    "/user/adam/parquet-encoding-1.6.0rc4.jar",
    "/user/adam/jcommander-1.27.jar",
    "/user/adam/juniversalchardet-1.0.3.jar",
    "/user/adam/commons-httpclient-3.1.jar",
    "/user/adam/fastutil-6.4.4.jar"
  };
