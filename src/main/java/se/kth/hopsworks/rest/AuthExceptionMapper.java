 ...
 */
@Provider
public class AuthExceptionMapper implements ExceptionMapper<AccessLocalException>{

    private final static Logger log = Logger.getLogger(AuthExceptionMapper.class.getName());
    @Override
