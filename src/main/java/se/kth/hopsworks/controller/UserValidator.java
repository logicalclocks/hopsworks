...
public class UserValidator {
    ...
    public boolean isValidPassword(String password, String confirmedPassword) throws AppException{
    ...
    public boolean isValidsecurityQA(String question, String answer) throws AppException{
