...
@NamedQueries({
    ...
    @NamedQuery(name = "Users.findByOrcid", query = "SELECT u FROM Users u WHERE u.orcid = :orcid"),
    ...
    @NamedQuery(name = "Users.findByValidationKey", query = "SELECT u FROM Users u WHERE u.validationKey = :validationKey"),
    ...
    @NamedQuery(name = "Users.findByYubikeyUser", query = "SELECT u FROM Users u WHERE u.yubikeyUser = :yubikeyUser"),
...
public class Users implements Serializable {
    ...
    public Users(Integer uid, String username, String password, Date activated, int falseLogin, boolean isonline, int yubikeyUser, Date passwordChanged, int status) {
        this.uid = uid;
