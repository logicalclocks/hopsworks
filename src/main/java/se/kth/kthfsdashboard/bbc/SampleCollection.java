...
public class SampleCollection implements Serializable {
  ...
  public String getDataAll() {
    ...
    all += dataSociodemographicCharacteristics
  ...
  public void setCategoryPhysiologicalMeasurements(
          boolean categoryPhysiologicalMeasurements) {
  ...
  public void setDataIndividualDiseaseHistory(
          boolean dataIndividualDiseaseHistory) {
  ...
  public void setDataIndividualHistoryOfInjuries(
          boolean dataIndividualHistoryOfInjuries) {
  ...
  public void setDataSociodemographicCharacteristics(
          boolean dataSociodemographicCharacteristics) {
    this.dataSociodemographicCharacteristics
            = dataSociodemographicCharacteristics;
  }
  ...
  public void setDataSocioeconomicCharacteristics(
          boolean dataSocioeconomicCharacteristics) {
