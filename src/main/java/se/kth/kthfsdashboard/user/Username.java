...
@NamedQueries({
    ...
    @NamedQuery(name = "Username.findAllByStatus", query = "SELECT r FROM Username r WHERE r.status = :status"),
...
//        }
    ...
    public Username(String email, String mobilenum, String name, String password, Date registeredon, byte[] salt, int status) {
        this.email = email;
        this.mobileNum = mobilenum;
        this.name = name;
