...
public class ProfileController implements Serializable {
  ...
  public static final String DEFAULT_GRAVATAR
          = "http://www.freeimages.com/assets/183003/1830029572/daisy-1445925-s.jpg";
  ...
  public Username getUser() {
    if (user == null) {
      try {
        ...
        //TODO: fix
        Logger.getLogger(ProfileController.class.getName()).log(Level.SEVERE,
                null, ex);
        return null;
      }
    }
...
//            throw new RuntimeException("Not logged in");
  ...
  public String getGravatar() {
    ...
    try {
      ...
      Logger.getLogger(UserController.class.getName()).log(Level.SEVERE, null,
              ex);
  ...
  public void changePasswordForm() {
    ...
    RequestContext.getCurrentInstance().openDialog("dialogs/changePassword",
            options, null);
  }
  ...
  public void changePassword() {
    ...
    String currentEncrypted = DatatypeConverter.printHexBinary(currentPwd.
            getBytes());

    if (oldPwd.compareTo(currentEncrypted) != 0) {
      //Wrong password            
      MessagesController.addErrorMessage("wrongPassword", "Error",
              "Wrong password.");
      return;
    }
    ...
    try {
      ...
      message = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed update",
