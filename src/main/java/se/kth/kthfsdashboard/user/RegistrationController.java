...
public class RegistrationController implements Serializable {
    ...
    private static final String REGISTERED_MESS = "Your registration request has been submitted for evaluation.";
    @EJB
    ...
    public String registerUser() {
        ...
        try {
            ...
            message = new FacesMessage(FacesMessage.SEVERITY_INFO, REGISTERED_SUM, REGISTERED_MESS);
        } catch (EJBException ejb) {
            message = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed registration.", "Something went wrong while trying to register your account.");
