...
//            RestContext<EC2Client, EC2AsyncClient> temp = service.getContext().unwrap();
    ...
    /*
     * This method iterates over the nodegroups defined in the cluster file
