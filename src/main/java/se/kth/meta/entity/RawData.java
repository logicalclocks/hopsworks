...
@NamedQueries({
    ...
    @NamedQuery(name = "RawData.findByFieldid", query = "SELECT r FROM RawData r WHERE r.fieldid = :fieldid"),
    @NamedQuery(name = "RawData.findByTupleid", query = "SELECT r FROM RawData r WHERE r.tupleid = :tupleid"),
    @NamedQuery(name = "RawData.lastInsertedTupleId",
            query = "SELECT r FROM RawData r GROUP BY r.tupleid ORDER BY r.tupleid desc")})
public class RawData implements Serializable, EntityIntf {
    ...
    public String toString() {
        return "entity.RawData[ id=" + id + ", fieldid=" + fieldid + ", tupleid=" + tupleid + ", data=" + data + " ]";
    }
