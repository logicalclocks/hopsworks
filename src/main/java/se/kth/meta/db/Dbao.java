...
//            this.deleteField(field);
    ...
    public int addTable(Tables table) throws DatabaseException {
        ...
        try {
            ...
            if (t != null) {
                /*
                 * if the table exists just update it, along with its corresponding child fields.
                 * Merge and cascade type ALL takes care of it, but first we need to copy the incoming table
                ...
                /*
                 * if the table is new then jpa cannot cascade insert to the child fields.
                 * we need to remove the fields in order for the table to be inserted first
                 * and acquire an id
                 */
                t = table;
                t.resetFields();
            ...
            //this.em.clear();
            return t.getId();
        } catch (NotSupportedException | IllegalStateException | SecurityException | HeuristicMixedException |
    ...
    public void addRawData(RawData raw) throws DatabaseException {
        ...
        try {
            ...
            throw new DatabaseException(Dbao.class.getName(), "Cound not store raw data " + e.getMessage());
        }
    }
