package io.hops.kmon.communication;
...
//    }
  ...
  public String getRoleLog(String hostAddress, String agentPassword, String cluster, String service, String role, int lines) {
    String url = createUrl("log", hostAddress, cluster, service, role, String.valueOf(lines));
    return fetchLog(url, agentPassword);
  }

  public String getServiceLog(String hostAddress, String agentPassword, String cluster, String service, int lines) {
  ...
  public List<NodesTableItem> getNdbinfoNodesTable(String hostAddress, String agentPassword) {
    ...
    public String executeRun(String hostAddress, String agentPassword, String cluster, String service, String role, String command, String[] params) throws Exception {
        return execute("execute/run", hostAddress, agentPassword, cluster, service, role, command, params);
    }
  public String executeStart(String hostAddress, String agentPassword, String cluster, String service, String role, String command, String[] params) throws Exception {
    return execute("execute/start", hostAddress, agentPassword, cluster, service, role, command, params);
  }

    public String executeContinue(String hostAddress, String agentPassword, String cluster, String service, String role, String command, String[] params) throws Exception {
        return execute("execute/continue", hostAddress, agentPassword, cluster, service, role, command, params);
    }
  private String execute(String path, String hostAddress, String agentPassword, String cluster, String service, String role, String command, String[] params) throws Exception {
    ...
    ClientResponse response = postWebResource(url, agentPassword, optionsAndParams);
  ...
  public ClientResponse doCommand(String hostAddress, String agentPassword, String cluster, String service, String role, String command) throws Exception {
    String url = createUrl("do", hostAddress, agentPassword, cluster, service, role, command);
...
//        log = log.replaceAll("\n", "<br>");
  ...
  private ClientResponse getWebResource(String url, String agentPassword) throws Exception {
  ...
  private ClientResponse postWebResource(String url, String agentPassword, String body) throws Exception {
    if (DISABLE_CERTIFICATE_VALIDATION) {
      disableCertificateValidation();
    }
    Client client = Client.create();
